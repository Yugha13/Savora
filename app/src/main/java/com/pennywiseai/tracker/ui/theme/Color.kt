...
val md_theme_dark_primary = Color(0xFFD0BCFF)  // Light purple for dark mode
val md_theme_dark_onPrimary = Color(0xFF381E72)  // Dark purple on light purple
val md_theme_dark_primaryContainer = Color(0xFF4F378B)  // Dark purple container
val md_theme_dark_onPrimaryContainer = Color(0xFFEADDFF)  // Light purple text
val md_theme_dark_secondary = Color(0xFFCCC2DC)  // Light purple-grey
val md_theme_dark_onSecondary = Color(0xFF332D41)  // Dark purple-grey
val md_theme_dark_secondaryContainer = Color(0xFF4A4458)  // Medium purple-grey
val md_theme_dark_onSecondaryContainer = Color(0xFFE8DEF8)  // Light purple-grey text
val md_theme_dark_tertiary = Color(0xFFEFB8C8)  // Light pinkish-purple
val md_theme_dark_onTertiary = Color(0xFF492532)  // Dark pink on light pink
val md_theme_dark_tertiaryContainer = Color(0xFF633B48)  // Medium pink container
val md_theme_dark_onTertiaryContainer = Color(0xFFFFD8E4)  // Light pink text
...
val md_theme_dark_inversePrimary = Color(0xFF6200EE)  // Deep purple
val md_theme_dark_surfaceTint = Color(0xFFD0BCFF)  // Light purple
